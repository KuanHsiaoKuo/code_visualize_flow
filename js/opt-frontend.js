...
exports.OptFrontend = exports.allTabsRE = void 0;
...
var OptFrontend = /** @class */ (function (_super) {
    ...
    function OptFrontend(params) {
        ...
        $('#genEmbedBtn').bind('click', function () {
            ...
            (0, pytutor_1.assert)(mod == 'display' || mod == 'visualize' /* deprecated */);
        ...
        */
        ...
        if ((0, opt_frontend_common_1.supports_html5_storage)() && !params.disableLocalStorageToggles) {
    ...
    OptFrontend.prototype.setAceMode = function () {
        ...
        if (selectorVal === 'java') {
            ...
            (0, pytutor_1.assert)(selectorVal === '2' || selectorVal == '3' || selectorVal == 'py3anaconda');
            mod = 'python';
            tabSize = 4; // PEP8 style standards
        }
        (0, pytutor_1.assert)(mod);
        var s = this.pyInputAceEditor.getSession();
    ...
    OptFrontend.prototype.snapshotCodeDiff = function () {
        (0, pytutor_1.assert)(this.deltaObj);
    ...
    OptFrontend.prototype.updateAppDisplay = function (newAppMode) {
        ...
        (0, pytutor_1.assert)(this.appMode === 'edit' || this.appMode === 'display'); // postcondition
    };
    ...
    OptFrontend.prototype.getAppState = function () {
        (0, pytutor_1.assert)(this.originFrontendJsFile);
    ...
    OptFrontend.prototype.parseQueryString = function () {
        ...
        if (queryStrOptions.codeopticonSession) {
            (0, pytutor_1.assert)(false); // TODO: this won't currently work with Webpack, so fix it later
