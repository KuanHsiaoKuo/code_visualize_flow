...
exports.supports_html5_storage = exports.generateUUID = exports.AbstractBaseFrontend = void 0;
...
var AbstractBaseFrontend = /** @class */ (function () {
    function AbstractBaseFrontend(params) {
        ...
        if (supports_html5_storage()) {
            ...
            (0, pytutor_1.assert)(this.userUUID);
        }
        else {
    ...
    AbstractBaseFrontend.prototype.executeCodeAndRunCallback = function (codeToExec, pyState, backendOptionsObj, frontendOptionsObj, execCallback) {
        ...
        if (jsonp_endpoint) {
            ...
            var retryOnBackupServer = function () {
                ...
                (0, pytutor_1.assert)(backup_jsonp_endpoint);
                $.ajax({
    ...
    AbstractBaseFrontend.prototype.traceCacheAdd = function () {
        ...
        (0, pytutor_1.assert)(this.myVisualizer && this.myVisualizer.curTrace);
        var appState = this.getAppState();
    ...
    AbstractBaseFrontend.prototype.setSurveyHTML = function () {
        ...
        var survey_v14 = "\n    <p style=\"font-size: 9pt; margin-top: 12px; margin-bottom: 15px; line-height: 150%;\">\n\n    Help improve this tool by completing a <a style=\"font-size: 10pt; font-weight: bold;\" href=\"https://docs.google.com/forms/d/e/1FAIpQLSfQJP1ojlv8XzXAvHz0al-J_Hs3GQu4XeblxT8EzS8dIzuaYA/viewform?entry.956368502=".concat(this.userUUID, "\" target=\"_blank\">short user survey</a>\n    </p>");
...
//# sourceMappingURL=opt-frontend-common.js.map