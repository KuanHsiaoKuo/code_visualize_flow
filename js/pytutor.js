...
exports.htmlspecialchars = exports.assert = exports.ExecutionVisualizer = exports.lightArrowColor = exports.darkArrowColor = exports.brightRed = exports.SVG_ARROW_POLYGON = void 0;
/* TODO:
    ...
    ExecutionVisualizer.prototype.updateOutputFull = function (smoothTransition) {
        ...
        if (isLastInstr) {
            if (this.promptForUserInput || this.promptForMouseInput) {
                msg = '<b><font color="' + exports.brightRed + '">Enter user input below:</font></b>';
            }
...
var DataVisualizer = /** @class */ (function () {
    ...
    DataVisualizer.prototype.renderDataStructures = function (curInstr) {
        ...
        myViz.domRoot.find('#heap')
            .empty()
            .html("<div id=\"heapHeader\">".concat(myViz.getRealLabel("Objects"), "</div>"));
...
//# sourceMappingURL=pytutor.js.map