...
exports.OptLiveFrontend = void 0;
...
var opt_frontend_2 = require("./opt-frontend");
...
var OptLiveFrontend = /** @class */ (function (_super) {
    ...
    OptLiveFrontend.prototype.updateStepLabels = function () {
        ...
        (0, pytutor_1.assert)(myVisualizer);
        ...
        if (curEntry.event === 'exception' ||
            ...
            (0, pytutor_1.assert)(curEntry.exception_msg);
            if (curEntry.exception_msg == "Unknown error") {
                ...
                $("#frontendErrorOutput").html((0, pytutor_1.htmlspecialchars)(curEntry.exception_msg));
            }
            ...
            $("#frontendErrorOutput").html((0, pytutor_1.htmlspecialchars)(myVisualizer.instrLimitReachedWarningMsg));
        }
        else {
        ...
        myVisualizer.add_pytutor_hook("end_updateOutput", function (args) {
            ...
            */
            ...
            if (args.myViz.creationTime) {
                ...
                (0, pytutor_1.assert)(uh.length > 0); // should already be seeded with an initial value
    ...
    OptLiveFrontend.prototype.initAceEditor = function (height) {
        var _this = this;
        (0, pytutor_1.assert)(!this.pyInputAceEditor);
        ...
        this.pyInputAceEditor.on('change', function (e) {
            ...
            if (curVal.indexOf('\t') >= 0) {
                _this.pyInputSetValue(curVal.replace(opt_frontend_2.allTabsRE, '    '));
    ...
    OptLiveFrontend.prototype.executeCodeAndCreateViz = function (codeToExec, pyState, backendOptionsObj, frontendOptionsObj, outputDiv) {
        ...
        (0, pytutor_1.assert)(backendScript);
        ...
        if (jsonp_endpoint) {
            (0, pytutor_1.assert)(pyState !== '2' && pyState !== '3');
...
}(opt_frontend_1.OptFrontend)); // END class OptLiveFrontend
...
//# sourceMappingURL=opt-live.js.map